...
public class IsisWicketApplication extends AuthenticatedWebApplication implements ComponentFactoryRegistryAccessor, PageClassRegistryAccessor, AuthenticationSessionProvider, BookmarkedPagesModelProvider {
    ...
    private void configureResourceBundles() {
        getResourceBundles().addJavaScriptBundle(IsisWicketApplication.class, "core.js",
...
//        getResourceBundles().addJavaScriptBundle(IsisWicketApplication.class, "bootstrap.js",
...
//        );
        ...
        getResourceBundles().addCssBundle(IsisWicketApplication.class, "bootstrap-extensions.css",
                                          Html5PlayerCssReference.instance(),
                                          OpenWebIconsCssReference.instance()
        );

//        getResourceBundles().addCssBundle(IsisWicketApplication.class, "application.css",
